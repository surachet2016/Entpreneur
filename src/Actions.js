...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("localhost/entrepreneur1/all_users.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = async (newUser) => {
    return fetch("localhost/entrepreneur1/add_users.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch("localhost/entrepreneur1/update_users.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteUser = (theID) => {
    ...
    fetch("localhost/entrepreneur1/delete_users.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
